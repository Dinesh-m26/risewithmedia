    ...
    <div className="relative overflow-hidden py-2">
      ...
      <motion.div
        ...
        {duplicated.map((client, i) => (
          <div
            key={`${client.name}-${i}`}
            className="flex items-center justify-center px-6 py-4 rounded-2xl border border-[#dff6ff] bg-white flex-shrink-0 hover:border-[#06b6d4]/40 hover:shadow-md transition-all duration-300"
    ...
    <div className="pt-28 sm:pt-32 pb-20 min-h-screen bg-white">
      ...
      <div className="text-center max-w-3xl mx-auto px-6 py-16">
        <motion.div
          ...
          <div className="inline-flex items-center gap-2 bg-[#dff6ff]/60 text-[#06b6d4] text-xs font-bold px-4 py-2 rounded-full mb-5">
            ✦ Our Happy Clients
          </div>
          <h1 className="text-5xl md:text-6xl font-black text-[#0f172a] mb-5">
      ...
      <div className="max-w-xl mx-auto px-6 mb-20">
        <div className="flex items-center gap-4">
          ...
          <span className="text-[#06b6d4] text-xs font-bold tracking-widest uppercase px-2">
            20+ Brands & Counting
          </span>
      ...
      <div className="bg-[#0f172a] relative overflow-hidden py-24">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[200px] bg-[#06b6d4]/10 blur-[100px] pointer-events-none" />
        ...
        <div ref={statsRef} className="relative max-w-6xl mx-auto px-6 lg:px-10">
          <motion.div className="text-center mb-14"
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white">
              Results That{" "}
              <span className="bg-gradient-to-r from-[#06b6d4] to-[#67e8f9] bg-clip-text text-transparent">
                Speak
              </span>
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((stat, i) => (
              <motion.div key={stat.label}
                className="text-center p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-[#06b6d4]/40 hover:bg-white/10 transition-all duration-300"
                initial={{ opacity: 0, y: 40 }}
                animate={statsInView ? { opacity: 1, y: 0 } : {}}
                transition={{ duration: 0.5, delay: i * 0.1 }}
                whileHover={{ y: -4 }}>
                <div className="text-4xl mb-3">{stat.icon}</div>
                <div className="text-4xl md:text-5xl font-black bg-gradient-to-br from-[#06b6d4] to-[#67e8f9] bg-clip-text text-transparent mb-2">
                  {stat.num}
                </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-24">
        <motion.div className="text-center mb-16"
          ...
          <div className="inline-flex items-center gap-2 bg-[#dff6ff]/60 text-[#06b6d4] text-xs font-bold px-4 py-2 rounded-full mb-4">
            Testimonials
          </div>
          <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-4">
            What Our Clients Say
          </h2>
          <p className="text-[#0f172a]/50 max-w-md mx-auto">
      ...
      {/* ─── INDUSTRIES STRIP ─────────────────────────────────────── */}
      <div className="bg-[#f7fcff] border-t border-b border-[#dff6ff]/60 py-14">
        <div className="max-w-6xl mx-auto px-6">
          <p className="text-center text-xs font-bold text-[#0f172a]/35 uppercase tracking-widest mb-8">
            Industries We Serve
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            {industries.map((ind, i) => (
              <motion.span key={ind}
                className="bg-white border border-[#dff6ff] text-[#0f172a]/60 text-sm font-semibold px-5 py-2.5 rounded-full hover:border-[#06b6d4] hover:text-[#06b6d4] hover:bg-white transition-all duration-300 cursor-default"
